...
<table style="width=90%;">
  ...
  <tr>
    <td style="text-align: justify;"> <i>Egocentric activity recognition (EAR) is an emerging area in the field of computer vision research. Motivated by the current success of Convolutional Neural Network (CNN), we propose a multistream CNN for multimodal egocentric activity recognition using
